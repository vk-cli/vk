...
void localize() {
  ...
  local["msg_setting2"] = lang(
      "show the selected text and unread ones",
  ...
  local["help_jump"] = lang(
      "Page Up/Down                   ->   Scroll up/down for a half of screen",
      "Page Up/Down                  ->   Прокрутить вверх/вниз на половину экрана");
  local["help_homend"] = lang(
